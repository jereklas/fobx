...
import type { ObservableObjectAdmin } from "../observables/object.ts"
...
/**
 * Check if a value is a flow (async generator wrapped by flow()).
 */
export function isFlow(value: Any): boolean {
  if (typeof value !== "function") return false
  return $fobx in value && value[$fobx] === "flow"
}
